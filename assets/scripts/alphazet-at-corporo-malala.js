...
import { getDatabase, ref, set, child, update, remove } from "https://www.gstatic.com/firebasejs/9.6.7/firebase-database.js";

const firebaseConfig = {
	apiKey: "AIzaSyBQfeFhnkr7rWzZXY0KvjiS4NPzM45MZ3M",
	authDomain: "alphazet-at-corporo-malala.firebaseapp.com",
	databaseURL: "https://alphazet-at-corporo-malala-default-rtdb.firebaseio.com",
	projectId: "alphazet-at-corporo-malala",
	storageBucket: "alphazet-at-corporo-malala.appspot.com",
	messagingSenderId: "997827609244",
	appId: "1:997827609244:web:26f0d2e57baae74cba6359",
	measurementId: "G-6V2PZV2S6Z"
};
...
$(".js-glossary-language").change(function() {
	var selectValue = $(".js-glossary-language option:selected").val();
	setGameLanguage(selectValue);
});

$(".js-deleteRow").click(function() {
